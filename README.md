...
### URLs de Acceso
- **Frontend**: https://conversion-tracker-4.preview.emergentagent.com
- **API Backend**: https://conversion-tracker-4.preview.emergentagent.com/api
- **Swagger Docs**: https://conversion-tracker-4.preview.emergentagent.com/api/docs
- **Health Check**: https://conversion-tracker-4.preview.emergentagent.com/api/health
...
2. **Login Tipster:**
   ```
   https://conversion-tracker-4.preview.emergentagent.com/login
...
5. **Compra (Simulada):**
   ...
   curl -X POST https://conversion-tracker-4.preview.emergentagent.com/api/webhooks/payments/confirm \
...
**Accede ahora:** https://conversion-tracker-4.preview.emergentagent.com
