...
### URLs de Acceso
- **Frontend**: https://channelmonitor.preview.emergentagent.com
- **API Backend**: https://channelmonitor.preview.emergentagent.com/api
- **Swagger Docs**: https://channelmonitor.preview.emergentagent.com/api/docs
- **Health Check**: https://channelmonitor.preview.emergentagent.com/api/health
...
2. **Login Tipster:**
   ```
   https://channelmonitor.preview.emergentagent.com/login
...
5. **Compra (Simulada):**
   ...
   curl -X POST https://channelmonitor.preview.emergentagent.com/api/webhooks/payments/confirm \
...
**Accede ahora:** https://channelmonitor.preview.emergentagent.com
