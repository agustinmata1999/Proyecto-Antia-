...
### URLs de Acceso
- **Frontend**: https://aff-metrics-fix.preview.emergentagent.com
- **API Backend**: https://aff-metrics-fix.preview.emergentagent.com/api
- **Swagger Docs**: https://aff-metrics-fix.preview.emergentagent.com/api/docs
- **Health Check**: https://aff-metrics-fix.preview.emergentagent.com/api/health
...
2. **Login Tipster:**
   ```
   https://aff-metrics-fix.preview.emergentagent.com/login
...
5. **Compra (Simulada):**
   ...
   curl -X POST https://aff-metrics-fix.preview.emergentagent.com/api/webhooks/payments/confirm \
...
**Accede ahora:** https://aff-metrics-fix.preview.emergentagent.com
