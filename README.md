...
### URLs de Acceso
- **Frontend**: https://telegram-product.preview.emergentagent.com
- **API Backend**: https://telegram-product.preview.emergentagent.com/api
- **Swagger Docs**: https://telegram-product.preview.emergentagent.com/api/docs
- **Health Check**: https://telegram-product.preview.emergentagent.com/api/health
...
2. **Login Tipster:**
   ```
   https://telegram-product.preview.emergentagent.com/login
...
5. **Compra (Simulada):**
   ...
   curl -X POST https://telegram-product.preview.emergentagent.com/api/webhooks/payments/confirm \
...
**Accede ahora:** https://telegram-product.preview.emergentagent.com
