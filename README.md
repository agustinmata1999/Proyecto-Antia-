...
### URLs de Acceso
- **Frontend**: https://tips-dashboard-1.preview.emergentagent.com
- **API Backend**: https://tips-dashboard-1.preview.emergentagent.com/api
- **Swagger Docs**: https://tips-dashboard-1.preview.emergentagent.com/api/docs
- **Health Check**: https://tips-dashboard-1.preview.emergentagent.com/api/health
...
2. **Login Tipster:**
   ```
   https://tips-dashboard-1.preview.emergentagent.com/login
...
5. **Compra (Simulada):**
   ...
   curl -X POST https://tips-dashboard-1.preview.emergentagent.com/api/webhooks/payments/confirm \
...
**Accede ahora:** https://tips-dashboard-1.preview.emergentagent.com
