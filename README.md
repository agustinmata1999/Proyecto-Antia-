...
### URLs de Acceso
- **Frontend**: https://sale-analytics.preview.emergentagent.com
- **API Backend**: https://sale-analytics.preview.emergentagent.com/api
- **Swagger Docs**: https://sale-analytics.preview.emergentagent.com/api/docs
- **Health Check**: https://sale-analytics.preview.emergentagent.com/api/health
...
2. **Login Tipster:**
   ```
   https://sale-analytics.preview.emergentagent.com/login
...
5. **Compra (Simulada):**
   ...
   curl -X POST https://sale-analytics.preview.emergentagent.com/api/webhooks/payments/confirm \
...
**Accede ahora:** https://sale-analytics.preview.emergentagent.com
