...
### URLs de Acceso
- **Frontend**: https://telegram-bot-fix-44.preview.emergentagent.com
- **API Backend**: https://telegram-bot-fix-44.preview.emergentagent.com/api
- **Swagger Docs**: https://telegram-bot-fix-44.preview.emergentagent.com/api/docs
- **Health Check**: https://telegram-bot-fix-44.preview.emergentagent.com/api/health
...
2. **Login Tipster:**
   ```
   https://telegram-bot-fix-44.preview.emergentagent.com/login
...
5. **Compra (Simulada):**
   ...
   curl -X POST https://telegram-bot-fix-44.preview.emergentagent.com/api/webhooks/payments/confirm \
...
**Accede ahora:** https://telegram-bot-fix-44.preview.emergentagent.com
