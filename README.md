...
### URLs de Acceso
- **Frontend**: https://antia-deploy.preview.emergentagent.com
- **API Backend**: https://antia-deploy.preview.emergentagent.com/api
- **Swagger Docs**: https://antia-deploy.preview.emergentagent.com/api/docs
- **Health Check**: https://antia-deploy.preview.emergentagent.com/api/health
...
2. **Login Tipster:**
   ```
   https://antia-deploy.preview.emergentagent.com/login
...
5. **Compra (Simulada):**
   ...
   curl -X POST https://antia-deploy.preview.emergentagent.com/api/webhooks/payments/confirm \
...
**Accede ahora:** https://antia-deploy.preview.emergentagent.com
