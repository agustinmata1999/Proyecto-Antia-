...
const getBaseUrl = () => {
  if (typeof window !== 'undefined') {
    // NEXT_PUBLIC_API_URL already includes /api, so we remove it for base URL
      ...
      {showAddHouseModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-lg w-full">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold">Añadir Casa a la Campaña</h2>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Este es el link específico de esta campaña para esta casa
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    min="0"
                    value={(houseLinkForm.commissionCents / 100).toFixed(2)}
                    onChange={(e) => setHouseLinkForm({ ...houseLinkForm, commissionCents: Math.round(parseFloat(e.target.value || '0') * 100) })}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                    placeholder="50.00"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Comisión que recibirá el tipster por cada conversión en esta campaña
                  </p>
                </div>
