...
export default function TelegramInstructions({ botUsername, onCopyBotUsername }: TelegramInstructionsProps) {
  ...
  const steps = [
    ...
    {
      number: '03',
      title: 'Conecta tu canal aquí',
      description: 'Escribe el nombre exacto de tu canal en el formulario de abajo y pulsa "Conectar canal".',
      icon: Settings,
      details: [
        'Copia el nombre de tu canal',
        'Pégalo en el campo de abajo',
        'Pulsa "Conectar canal"',
    ...
    },
    {
      number: '04',
      title: '¡Listo!',
      description: 'Tus clientes recibirán acceso automáticamente al canal cuando compren una suscripción.',
      icon: Send,
      details: [
        'El bot añadirá usuarios automáticamente',
        'Publica tus pronósticos en el canal',
        'Los clientes acceden tras la compra',
      ],
    },
  ];
